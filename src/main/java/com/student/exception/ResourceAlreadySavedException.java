...
public class ResourceAlreadySavedException extends RuntimeException {
    ...
    public ResourceAlreadySavedException(String message, String resourceName) {
        super(message);
        this.resourceName = resourceName;
    }

    public ResourceAlreadySavedException(String resourceName, String fieldName, Object fieldValue) {
